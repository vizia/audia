...
pub fn search_results_panel(
    ...
    VStack::new(cx, move |cx| {
        ...
        TabView::new(cx, search_tabs, move |_, index, item| match index {
            ...
            1 => TabPair::new(
                ...
                move |cx| {
                    ...
                    .selectable(Selectable::Single)
                    .selection_follows_focus(true)
                    .on_select(|cx, idx| cx.emit(SearchEvent::SelectArtist(idx)))
                    .width(Stretch(1.0))
                    .height(Stretch(1.0));
                },
            ),
            2 => TabPair::new(
                ...
                move |cx| {
                    ...
                    .selectable(Selectable::Single)
                    .selection_follows_focus(true)
                    .on_select(|cx, idx| cx.emit(SearchEvent::SelectAlbum(idx)))
                    .width(Stretch(1.0))
                    .height(Stretch(1.0));
                },
            ),
        ...
        .on_select(|cx, index| cx.emit(SearchEvent::SelectTab(index)))
        .class("search-tabs")
        .width(Stretch(1.0))
        .height(Stretch(1.0));
    })
