...
use crate::ui::events::{AlbumEvent, PlaylistsEvent};
    ...
    VStack::new(cx, move |cx| {
        HStack::new(cx, |cx| {
            ...
            Button::new(cx, |cx| Svg::new(cx, ICON_PLAYER_PLAY_FILLED))
                ...
                .on_press(|cx| cx.emit(AlbumEvent::PlayAlbum));
            ...
            .on_press(|cx| cx.emit(AlbumEvent::ToggleShuffleAlbum));
        })
        .class("album-header");
        ...
        .on_select(|cx, idx| cx.emit(AlbumEvent::AlbumTrackSelected(idx)))
        .width(Stretch(1.0))
        .height(Stretch(1.0));
    })
    .class("panel")
